...
public class ArraytoArrayList {
    ...
    public static void main(String [] args)
    {
        ...
        System.out.println("Array to Arraylist using .asList()method:  ");
        obj.arraytoArrayListMethod1();
        
        System.out.println("Array to Arraylist using direct method:  ");
        obj.arraytoArrayListMethod2();
